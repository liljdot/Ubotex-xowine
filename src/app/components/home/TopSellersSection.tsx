...
const WineCard: React.FC<{ title: string, image: StaticImageData }> = ({ title, image }) => {
    ...
    return (
        <>
            <div className="card bg-base-100 w-22.5 xl:w-91 rounded-none shrink-0 xl:p-5">
                <figure className="h-22 xl:h-75.5">
                    <img
                        src={image.src}
                        alt="wine"
                        className="" />
...
const TopSellersSection: React.FC = () => {
    ...
    return (
        <>
            <section className="flex flex-col gap-5 md:gap-6 py-16 xl:py-40">
                ...
                <div className="flex flex-col md:flex-col-reverse gap-2.5 xl:gap-15 px-9.5 xl:px-36">
                    <div className="flex flex-row justify-center gap-4 xl:gap-7">
