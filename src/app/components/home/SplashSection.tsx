...
const Quote: React.FC<Props> = ({ text, positionClassName, author }) => {
    ...
    return (
        <div className={"absolute flex flex-col max-w-19.5 xl:max-w-68.5 " + positionClassName}>
            <h6 className="text-[10px] xl:text-2xl">
                {text}
            </h6>
...
const SplashSection: React.FC = () => {
    ...
    return (
        <>
            <section className="w-full px-14 xl:px-50 mb-12.5">
